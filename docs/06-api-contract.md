...
```json
{
  ...
  "matches": [
    { "id": "apple-iphone-13-pro-max", "name": "iPhone 13 Pro Max", "score": 0.98 }
  ],
  "reasons": [
    { "code": "LAYOUT_OK" },
...
```json
{
  ...
  "matches": [
    ...
    { "id": "samsung-galaxy-s23-plus", "name": "Galaxy S23+", "score": 0.88, "esimSupport": "supported" },
    { "id": "samsung-galaxy-s23-ultra", "name": "Galaxy S23 Ultra", "score": 0.88, "esimSupport": "supported" },
    { "id": "samsung-galaxy-s23-fe", "name": "Galaxy S23 FE", "score": 0.85, "esimSupport": "supported" }
  ],

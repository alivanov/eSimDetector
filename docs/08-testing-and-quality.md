...
**Фактическое состояние выборки (агент 6.6, docs/09-decisions.md ADR-042; дополнение полевым сбором 2026-08-25…2026-08-26).** `data/fixtures/signals.golden.json` наполнен — **136 записей**, все девять обязательных групп непусты:
...
| `android-vendor-ua-ch` | 37      | 26 `public-ua-database` (составные) + 11 `real-device` (Pixel 9; S25 Ultra; S24 SM-S9210; Note 13 Pro; Note 9 Pro; Galaxy A21s SM-A217F; Galaxy A10 SM-A105F; Mi 8 Pro / Яндекс.Браузер; realme 14 Pro+ RMX5051; Galaxy A50 SM-A505FN; Honor 8 Lite PRA-TL10) |

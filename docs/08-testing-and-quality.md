...
**Фактическое состояние выборки (агент 6.6, docs/09-decisions.md ADR-042; дополнение полевым сбором 2026-08-25…2026-08-28).** `data/fixtures/signals.golden.json` наполнен — **139 записей**, все девять обязательных групп непусты:
...
| `android-vendor-ua-ch` | 40      | 26 `public-ua-database` (составные) + 14 `real-device` (Pixel 9; S25 Ultra; S24 SM-S9210; Note 13 Pro; Note 9 Pro; Galaxy A21s SM-A217F; Galaxy A10 SM-A105F; Mi 8 Pro / Яндекс.Браузер; realme 14 Pro+ RMX5051; Galaxy A50 SM-A505FN; Honor 8 Lite PRA-TL10; Galaxy Note10 Lite SM-N770F; Galaxy S23 SM-S911N; Huawei Pura 70 ADY-LX9) |

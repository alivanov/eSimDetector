...
Фактическое состояние наполнения на момент завершения сбора первичных данных существенно отличается от таблицы выше и описано в [приложении А](./appendix-a-llm-csv-request.md) §А.8.3: в собранном массиве нет ни одной записи с платформой `ios` или `harmonyos` и ни одной записи с типом устройства, отличным от `phone`. Обе критические группы таблицы — Apple iPhone и часть Samsung (Note, Z) — не собраны.

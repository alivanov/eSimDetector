...
- запросы выгрузок по партиям из [приложения А](./appendix-a-llm-csv-request.md) у двух-трёх разных моделей; перед массовым прогоном — проверка пригодности источника на одной партии (§А.8);
